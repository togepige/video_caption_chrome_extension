...
CaptionUtil.formatCaptionData = function (captions) {
    ...
    $.map(captions, function (caption) {
        ...
        if (caption.chosen_version) {} else if (caption.modifications && caption.modifications.length) {
